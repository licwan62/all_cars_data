...
def main() -> None:
    ...
    check(
        ...
        all(base_dimension_id(row.get("DIMENSION-ID", "")) == dimension_id(row) for row in source),
    )
    ...
    if RESULT.exists():
        ...
        expectations = [
            ...
            ("Nissan", "Maxima", "Sedan", "gen4", "SD1"),
            ("BMW", "3 Series", "Sedan", "gen2", "SD1"),
            ("Chevrolet", "Bel Air", "Sedan", "", "SD2"),
            ("Ford", "Crown Victoria", "Sedan", "", "SD2"),
            ("Tesla", "Model Y", "", "", "SU0"),
            ("Tesla", "Model Y L", "", "", "SU0"),
            ("Porsche", "Macan", "", "", "SU0"),
            ("Genesis", "GV60", "", "", "SU0"),
    ...
    output = PROJECT / "output" / "validation_report.json"
