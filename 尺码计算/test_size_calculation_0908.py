...
INPUT = ROOT / "public" / "全量数据.csv"
REFERENCES = ROOT / "public" / "参考尺寸计算.csv"
RULES = ROOT / "尺码计算" / "rules" / "尺码匹配规则-0908.csv"
PARAMETERS = ROOT / "尺码计算" / "rules" / "尺码匹配参数.csv"
OUTPUT = ROOT / "尺码计算" / "output" / "尺码计算测试-0908.csv"
REPORT = ROOT / "尺码计算" / "output" / "尺码计算测试-0908.json"
